                    ...
                    <td class="px-4 ">
                        <div class="flex gap-2 justify-center items-center">
                            <a href="{{ route('admin.editData', $item->id) }}" class="bg-blue-600 flex gap-1 p-2 items-center hover:bg-blue-700 active:bg-blue-600 transition-colors rounded-md text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="m14.06 9l.94.94L5.92 19H5v-.92zm3.6-6c-.25 0-.51.1-.7.29l-1.83 1.83l3.75 3.75l1.83-1.83c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.2-.2-.45-.29-.71-.29m-3.6 3.19L3 17.25V21h3.75L17.81 9.94z"/></svg>
